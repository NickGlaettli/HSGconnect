...
[SwitchDrive](https://drive.switch.ch) via WebDAV. Browse folders, read data
files, and import BFS survey data — directly from R, without manual downloads.
...
You need an **app-specific password** for SwitchDrive (not your university login):
